...
var nowBnbAmount = "700000000000000000";
var buyNode = function(_parentAddress){
	controlContractInstance.methods.buyNode(_parentAddress).send({from:selectAddress,gasPrice: gasPrice,value:nowBnbAmount}).then(function(res){
		console.log(res)
		tishi('完成');
		depositDataInit();
